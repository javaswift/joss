...
public class DownloadObjectCommandTest extends BaseCommandTest {
    ...
    public void downloadSuccess() throws IOException {
        ...
        byte[] result = new DownloadObjectAsByteArrayCommand(httpClient, defaultAccess, account.getContainer("containerName"), getObject("objectname")).call();
    ...
    public void md5Mismatch() throws IOException {
        ...
        checkForError(200, new DownloadObjectAsByteArrayCommand(httpClient, defaultAccess, account.getContainer("containerName"), getObject("objectname")), CommandExceptionError.MD5_CHECKSUM);
    }

    @Test
    public void objectNotFound() throws IOException {
        checkForError(404, new DownloadObjectAsByteArrayCommand(httpClient, defaultAccess, account.getContainer("containerName"), getObject("objectname")), CommandExceptionError.CONTAINER_DOES_NOT_EXIST);
    }

    @Test
    public void unknownError() throws IOException {
        checkForError(500, new DownloadObjectAsByteArrayCommand(httpClient, defaultAccess, account.getContainer("containerName"), getObject("objectname")), CommandExceptionError.UNKNOWN);
    }
}
