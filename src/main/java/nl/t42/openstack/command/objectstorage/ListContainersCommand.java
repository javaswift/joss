...
public class ListContainersCommand extends AbstractSecureCommand<HttpGet, String[]> {
    ...
    @Override
    protected String[] getReturnObject(HttpResponse response) throws IOException {
