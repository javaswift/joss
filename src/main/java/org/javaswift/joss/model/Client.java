 ...
 * </ul>
 * Call {@link #authenticate(String, String, String, String, String) authenticate} to get an {@link Account} which allows
...
public interface Client<A extends Account> {
    ...
    * @param tenantName the account name the user is authenticated against
    * @param tenantId the account ID the user is authenticated against
